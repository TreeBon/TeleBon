...
import org.telegrambon.PhoneFormat.PhoneFormat;
import org.telegrambon.messenger.BuildConfig;
import org.telegrambon.messenger.BuildVars;
import org.telegrambon.messenger.ChatObject;
import org.telegrambon.messenger.MediaDataController;
import org.telegrambon.messenger.Emoji;
import org.telegrambon.messenger.ImageLocation;
import org.telegrambon.messenger.LocaleController;
import org.telegrambon.messenger.MediaController;
import org.telegrambon.messenger.MessagesStorage;
import org.telegrambon.messenger.SecretChatHelper;
import org.telegrambon.messenger.SendMessagesHelper;
import org.telegrambon.messenger.SharedConfig;
import org.telegrambon.messenger.UserObject;
import org.telegrambon.messenger.Utilities;
import org.telegrambon.messenger.VideoEditedInfo;
import org.telegrambon.messenger.browser.Browser;
import org.telegrambon.messenger.support.SparseLongArray;
import org.telegrambon.messenger.ApplicationLoader;
import org.telegrambon.messenger.FileLoader;
import org.telegrambon.tgnet.ConnectionsManager;
import org.telegrambon.tgnet.TLObject;
import org.telegrambon.tgnet.TLRPC;
import org.telegrambon.messenger.ContactsController;
import org.telegrambon.messenger.FileLog;
import org.telegrambon.messenger.MessageObject;
import org.telegrambon.messenger.MessagesController;
import org.telegrambon.messenger.NotificationCenter;
import org.telegrambon.messenger.R;
import org.telegrambon.ui.ActionBar.ActionBarLayout;
import org.telegrambon.ui.ActionBar.ActionBarPopupWindow;
import org.telegrambon.ui.ActionBar.AlertDialog;
import org.telegrambon.ui.ActionBar.BackDrawable;
import org.telegrambon.ui.ActionBar.BottomSheet;
import org.telegrambon.ui.ActionBar.SimpleTextView;
import org.telegrambon.ui.ActionBar.ThemeDescription;
import org.telegrambon.ui.Adapters.MentionsAdapter;
import org.telegrambon.ui.Adapters.StickersAdapter;
import org.telegrambon.ui.Cells.BotSwitchCell;
import org.telegrambon.ui.Cells.ChatActionCell;
import org.telegrambon.ui.Cells.ChatLoadingCell;
import org.telegrambon.ui.ActionBar.ActionBar;
import org.telegrambon.ui.ActionBar.ActionBarMenu;
import org.telegrambon.ui.ActionBar.ActionBarMenuItem;
import org.telegrambon.ui.Cells.ChatMessageCell;
import org.telegrambon.ui.Cells.ChatUnreadCell;
import org.telegrambon.ui.Cells.CheckBoxCell;
import org.telegrambon.ui.Cells.ContextLinkCell;
import org.telegrambon.ui.Cells.MentionCell;
import org.telegrambon.ui.ActionBar.ActionBarMenuSubItem;
import org.telegrambon.ui.Cells.StickerCell;
import org.telegrambon.ui.Components.AlertsCreator;
import org.telegrambon.ui.Components.AnimatedFileDrawable;
import org.telegrambon.ui.Components.AnimationProperties;
import org.telegrambon.ui.Components.BackupImageView;
import org.telegrambon.ui.ActionBar.BaseFragment;
import org.telegrambon.ui.Cells.BotHelpCell;
import org.telegrambon.ui.Components.ChatActivityEnterView;
import org.telegrambon.messenger.ImageReceiver;
import org.telegrambon.ui.Components.ChatAttachAlert;
import org.telegrambon.ui.Components.ChatAvatarContainer;
import org.telegrambon.ui.Components.ChatBigEmptyView;
import org.telegrambon.ui.Components.CombinedDrawable;
import org.telegrambon.ui.Components.CorrectlyMeasuringTextView;
import org.telegrambon.ui.Components.EditTextCaption;
import org.telegrambon.ui.Components.EmbedBottomSheet;
import org.telegrambon.ui.Components.EmojiView;
import org.telegrambon.ui.Components.ExtendedGridLayoutManager;
import org.telegrambon.ui.Components.FragmentContextView;
import androidx.recyclerview.widget.GridLayoutManagerFixed;
import org.telegrambon.ui.Components.InstantCameraView;
import org.telegrambon.ui.Components.LayoutHelper;
import org.telegrambon.ui.Components.HintView;
import org.telegrambon.ui.Components.NumberTextView;
import org.telegrambon.ui.Components.PipRoundVideoView;
import org.telegrambon.ui.Components.RLottieDrawable;
import org.telegrambon.ui.Components.RadialProgressView;
import org.telegrambon.ui.Components.RecyclerListView;
import org.telegrambon.ui.Components.ShareAlert;
import org.telegrambon.ui.Components.Size;
import org.telegrambon.ui.Components.SizeNotifierFrameLayout;
import org.telegrambon.ui.Components.StickersAlert;
import org.telegrambon.ui.ActionBar.Theme;
import org.telegrambon.ui.Components.TextStyleSpan;
import org.telegrambon.ui.Components.TypefaceSpan;
import org.telegrambon.ui.Components.URLSpanBotCommand;
import org.telegrambon.ui.Components.URLSpanMono;
import org.telegrambon.ui.Components.URLSpanNoUnderline;
import org.telegrambon.ui.Components.URLSpanReplacement;
import org.telegrambon.ui.Components.URLSpanUserMention;
import org.telegrambon.ui.Components.UndoView;
import org.telegrambon.ui.Components.voip.VoIPHelper;
                    ...
                    if ((index = animatingMessageObjects.indexOf(message)) != -1) {
                        ...
                        messageCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                org.telegrambon.ui.Components.Rect rect = instantCameraView.getCameraRect();
